...
public class NearMeApplication {
    ...
    CommandLineRunner initData(
            ...
            ActivityRepository aRepo, EventRepository eRepo, TouristSpotRepository lRepo
    ) {
        return args -> {
    ...
    private void addRajahmundryData(MovieRepository mRepo, RestaurantRepository rRepo, ShopRepository shRepo,
        ...
        saveTouristSpot(lRepo, "Godavari Arch Bridge", "Godavari, "           + city, 4.8, "godavari_bridge.jpg");
        saveTouristSpot(lRepo, "ISKCON Temple",         "Godavari Bund Road, " + city, 4.7, "iskcon_rjy.jpg");
        saveTouristSpot(lRepo, "Papi Hills",            "Papi Kondalu, near "  + city, 4.9, "papi_hills.jpg");
        saveTouristSpot(lRepo, "Cotton Museum",         "Dowleswaram, "        + city, 4.1, "cotton_museum.jpg");
        saveTouristSpot(lRepo, "Maredumilli Forest",    "Maredumilli, near "   + city, 4.6, "maredumilli.jpg");
    ...
    private void addHyderabadData(MovieRepository mRepo, RestaurantRepository rRepo, ShopRepository shRepo,
        ...
        saveRestaurant(rRepo, "Paradise Biryani", "Mughlai",     "Secunderabad, " + city, 4.8,
            wiki("a/ad/Hyderabadi_biryani1.jpg/480px-Hyderabadi_biryani1.jpg"),
        ...
        saveTouristSpot(lRepo, "Charminar",        "Old City, "   + city, 4.7,
            wiki("2/20/Charminar-Hyderabad.jpg/480px-Charminar-Hyderabad.jpg"));
        saveTouristSpot(lRepo, "Ramoji Film City",  "Anaspur, "    + city, 4.6, "ramoji_film_city.jpg");
        saveTouristSpot(lRepo, "Golconda Fort",     "Khairtabad, " + city, 4.8,
            wiki("d/db/Golconda_Fort_1.jpg/480px-Golconda_Fort_1.jpg"));
        saveTouristSpot(lRepo, "Hussain Sagar",     "Tank Bund, "  + city, 4.5,
            wiki("7/79/Hussain_Sagar_1.jpg/480px-Hussain_Sagar_1.jpg"));
        saveTouristSpot(lRepo, "Salar Jung Museum", "Afzal Gunj, " + city, 4.6, "salar_jung.jpg");
    ...
    private void addVijayawadaData(MovieRepository mRepo, RestaurantRepository rRepo, ShopRepository shRepo,
        ...
        saveTouristSpot(lRepo, "Prakasam Barrage",   "Krishna River, "      + city, 4.7, "prakasam_barrage.jpg");
        saveTouristSpot(lRepo, "Bhavani Island",    "Krishna River, "      + city, 4.8, "bhavani_island.jpg");
        saveTouristSpot(lRepo, "Kanaka Durga Temple","Indrakeeladri Hills, "+ city, 4.9,
            wiki("b/b5/Kanaka_Durga_Temple_View.jpg/480px-Kanaka_Durga_Temple_View.jpg"));
        saveTouristSpot(lRepo, "Rajiv Gandhi Park", "River Front, "        + city, 4.3, "rajiv_gandhi_park.jpg");
        saveTouristSpot(lRepo, "Undavalli Caves",   "Near Guntur, "        + city, 4.6, "undavalli_caves.jpg");
    ...
    private void addGunturData(MovieRepository mRepo, RestaurantRepository rRepo, ShopRepository shRepo,
        ...
        saveTouristSpot(lRepo, "Uppalapadu Bird Sanctuary","Uppalapadu, near "       + city, 4.6, "uppalapadu.jpg");
        saveTouristSpot(lRepo, "Kondaveedu Fort",           "Kondaveedu Hills, near " + city, 4.7, "kondaveedu_fort.jpg");
        saveTouristSpot(lRepo, "Sri Amaravati Stupa",       "Amaravati, near "        + city, 4.8, "amaravati_stupa.jpg");
        saveTouristSpot(lRepo, "Guntur Market",             "Brodipet, "              + city, 4.0, "guntur_market.jpg");
        saveTouristSpot(lRepo, "Ethipothala Falls",         "Near Nagarjuna Sagar, "  + city, 4.9, "ethipothala_falls.jpg");
    ...
    private void addChennaiData(MovieRepository mRepo, RestaurantRepository rRepo, ShopRepository shRepo,
        ...
        saveTouristSpot(lRepo, "Marina Beach",          "Santhome, "        + city, 4.8,
            wiki("4/44/Marina_Beach_Chennai_Panorama.jpg/480px-Marina_Beach_Chennai_Panorama.jpg"));
        saveTouristSpot(lRepo, "VGP Universal Kingdom", "East Coast Road, " + city, 4.5, "vgp.jpg");
        saveTouristSpot(lRepo, "Elliot's Beach",        "Besant Nagar, "    + city, 4.7, "elliots.jpg");
        saveTouristSpot(lRepo, "Fort St. George",       "George Town, "     + city, 4.3, "fort_st_george.jpg");
        saveTouristSpot(lRepo, "Kapaleeshwarar Temple", "Mylapore, "        + city, 4.9, "kapaleeshwarar_temple.jpg");
    ...
    private void addBangaloreData(MovieRepository mRepo, RestaurantRepository rRepo, ShopRepository shRepo,
        ...
        saveTouristSpot(lRepo, "Lalbagh Botanical Garden","South Bangalore, "+ city, 4.8,
            wiki("1/1c/Lalbagh_Botanical_Garden_Glass_House_Bangalore.jpg/480px-Lalbagh_Botanical_Garden_Glass_House_Bangalore.jpg"));
        saveTouristSpot(lRepo, "Cubbon Park",              "MG Road, "        + city, 4.7, "cubbon_park.jpg");
        saveTouristSpot(lRepo, "Bangalore Palace",         "Vasanth Nagar, "  + city, 4.6, "bangalore_palace.jpg");
        saveTouristSpot(lRepo, "ISKCON Temple",            "Rajajinagar, "    + city, 4.9, "iskcon_blr.jpg");
        saveTouristSpot(lRepo, "Wonderla",                 "Mysore Road, "    + city, 4.8, "wonderla.jpg");
    ...
    private void addNewDelhiData(MovieRepository mRepo, RestaurantRepository rRepo, ShopRepository shRepo,
        ...
        saveTouristSpot(lRepo, "India Gate",     "Central Delhi, "+ city, 4.8,
            wiki("1/17/India_Gate_in_New_Delhi_03-2016.jpg/480px-India_Gate_in_New_Delhi_03-2016.jpg"));
        saveTouristSpot(lRepo, "Red Fort",       "Old Delhi, "    + city, 4.7, "redfort.jpg");
        saveTouristSpot(lRepo, "Qutub Minar",    "Mehrauli, "     + city, 4.8,
            wiki("1/1f/Qutb_Minar.jpg/480px-Qutb_Minar.jpg"));
        saveTouristSpot(lRepo, "Lotus Temple",   "Kalkaji, "      + city, 4.7, "lotustemple.jpg");
        saveTouristSpot(lRepo, "Humayun's Tomb", "Nizamuddin, "   + city, 4.7, "humayunstomb.jpg");
    ...
    private void addMumbaiData(MovieRepository mRepo, RestaurantRepository rRepo, ShopRepository shRepo,
        ...
        saveTouristSpot(lRepo, "Gateway of India",           "Colaba, "              + city, 4.9,
            wiki("3/3a/Mumbai_03-2016_30_Gateway_of_India.jpg/480px-Mumbai_03-2016_30_Gateway_of_India.jpg"));
        saveTouristSpot(lRepo, "Marine Drive",               "South Mumbai, "        + city, 4.8, "marinedrive.jpg");
        saveTouristSpot(lRepo, "Juhu Beach",                 "Juhu, "                + city, 4.6, "juhubeach.jpg");
        saveTouristSpot(lRepo, "Sanjay Gandhi National Park","Borivali, "            + city, 4.7, "sgnp.jpg");
        saveTouristSpot(lRepo, "Elephanta Caves",            "Gharapuri Island, near "+ city, 4.6, "elephanta.jpg");
    ...
    private String getMoviePosterUrl(String fileNameOrUrl) {
        if (fileNameOrUrl == null || fileNameOrUrl.isEmpty())
            return "https://picsum.photos/seed/cinema-poster/320/460";
        if (fileNameOrUrl.startsWith("http")) return fileNameOrUrl;
        ClassPathResource resource = new ClassPathResource("static/images/" + fileNameOrUrl);
        if (resource.exists()) return "/images/" + fileNameOrUrl;
        String seed = fileNameOrUrl.replaceAll("\\.[^.]+$", "").replace("_", "-");
        return "https://picsum.photos/seed/" + seed + "/320/460";
    }

    private void saveMovie(MovieRepository repo, String title, String genre, double rating,
                           String filename, String location) {
        Movie movie = new Movie(title, genre, rating, getMoviePosterUrl(filename), location);
    ...
    private void saveTouristSpot(TouristSpotRepository repo, String name, String area,
                                 double rating, String filename) {
        TouristSpot spot = new TouristSpot();
        spot.setName(name);
        spot.setArea(area);
        spot.setRating(rating);
        spot.setImage(getImageUrl(filename));
        repo.save(spot);
    }
    ...
    /* Returns a usable image URL: local static file if it exists,
       otherwise a consistent seed-based Picsum photo. */
    private String getImageUrl(String fileNameOrUrl) {
        if (fileNameOrUrl == null || fileNameOrUrl.isEmpty())
            return "https://picsum.photos/seed/nearme-default/480/320";
        if (fileNameOrUrl.startsWith("http")) return fileNameOrUrl;
        ClassPathResource resource = new ClassPathResource("static/images/" + fileNameOrUrl);
        if (resource.exists()) return "/images/" + fileNameOrUrl;
        String seed = fileNameOrUrl.replaceAll("\\.[^.]+$", "").replace("_", "-");
    ...
    private static String wiki(String path) {
